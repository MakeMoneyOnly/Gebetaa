...
The provided `seed-data.sql` has **critical column mismatches** with the current database schema. The seed was designed for an older/different schema version and will fail on the current Gebeta database.
