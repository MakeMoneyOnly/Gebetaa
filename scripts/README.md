...
```
*This will create `public/splash-bg-opt.webp` next to the original file.*
...
```
*This will optimize the image and also create a `public/splash-bg-base64.txt` file containing the base64 string.*
