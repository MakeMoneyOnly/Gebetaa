...
*   **Historical Baselines:** Missing comparative metrics (e.g., "12,450 ETB — up 8% vs *same day last week*") on the front screen.
...
2. **Top Mover Commodities:** (What is selling *right now*).
