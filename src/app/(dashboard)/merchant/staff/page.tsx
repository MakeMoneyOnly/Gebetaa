...
export default function StaffPage() {
    ...
    const displayLoading = staffDataLoading || devicesDataLoading || pageLoading;
    ...
    return (
        <div className="font-manrope min-h-screen space-y-8 pb-20">
            {/* Header */}
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
                <div>
                    ...
                    <p className="font-medium text-gray-500">
                        Manage your staff PINs, roles, and provisioned hardware.
                    </p>
                </div>
                <div className="flex gap-3">
                    <button
                        onClick={() => setAddDeviceOpen(true)}
                        className="flex h-12 flex-1 items-center justify-center gap-2 rounded-xl bg-white px-5 text-sm font-bold text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:shadow md:flex-none"
                    >
                    ...
                    <button
                        ...
                        className="bg-brand-crimson flex h-12 flex-1 items-center justify-center gap-2 rounded-xl px-5 text-sm font-bold text-white shadow-lg shadow-black/10 transition-colors hover:bg-[#a0151e] md:flex-none"
                    >
