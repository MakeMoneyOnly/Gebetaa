                                ...
                                {step === "email" ? (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to Gebeta</h1>
                                            ...
                                            <form onSubmit={handleEmailSubmit}>
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full backdrop-blur-[1px] bg-white/5 text-white border-1 border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border focus:border-white/30 text-center"
                                                        required
                                                    />
                                                    <button
                                                        type="submit"
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[1.25rem] text-white/50 font-light">Welcome to Gebeta</p>
                                        </div>
