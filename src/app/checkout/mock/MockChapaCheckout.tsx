...
const PAYMENT_METHODS = [
    {
        ...
        color: '#FF6B00',
        emoji: '📱',
        desc: 'M-Pesa-like mobile wallet',
    },
    {
    ...
    {
        id: 'awash' as PaymentMethod,
        name: 'Awash Bank',
        color: '#003087',
        emoji: '🏦',
        desc: 'Awash Bank mobile',
    },
    {
        id: 'dashen' as PaymentMethod,
        name: 'Dashen Bank',
        color: '#C8102E',
        emoji: '🏦',
        desc: 'Dashen Bank',
...
export default function MockChapaCheckout() {
    ...
    useEffect(() => {
        ...
        if (countdown <= 0) {
            ...
            void fetch(
                '/api/payments/chapa/webhook?trx_ref=' +
                    txRef +
        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
            <div className="w-full max-w-sm overflow-hidden rounded-[28px] bg-white shadow-2xl">
                ...
                <div className="flex items-center gap-2 border-b border-amber-100 bg-amber-50 px-4 py-2">
                    <span className="text-xs font-black text-amber-600">⚠ DEMO MODE</span>
                    <span className="text-xs text-amber-700">No real payment — testing only</span>
                </div>
                            ...
                            <div className="space-y-2">
                                {PAYMENT_METHODS.map(m => (
                                    ...
                                    >
                                        ...
                                        {selectedMethod === m.id && (
                                            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#2D1B69]">
                                ...
                                <div className="space-y-3">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pr-4 pl-10 text-sm font-medium outline-none focus:border-[#2D1B69] focus:ring-2 focus:ring-[#2D1B69]/20"
                                        />
                                    </div>
                                    <input
                                        type="password"
                ...
                {(step === 'select' || step === 'enter') && (
                    <div className="space-y-3 px-6 pb-6">
                        <button
                            ...
                            className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl font-black text-white transition-transform active:scale-95"
                            style={{
                                background: 'linear-gradient(135deg, #2D1B69 0%, #4B2CC4 100%)',
                            }}
                        >
