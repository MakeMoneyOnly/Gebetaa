...
const CreatePayoutSchema = z.object({
    ...
    gross: z.coerce.number().min(0).max(1000000000),
    fees: z.coerce.number().min(0).max(1000000000).optional().default(0),
    adjustments: z.coerce.number().min(-1000000000).max(1000000000).optional().default(0),
    net: z.coerce.number().min(-1000000000).max(1000000000).optional(),
