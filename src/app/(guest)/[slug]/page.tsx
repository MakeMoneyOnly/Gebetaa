                ...
                <div className="relative z-10 mx-auto flex h-full max-w-md flex-col px-25 pb-[calc(10vh-30px)]">
                    <div className="mt-auto space-y-1">
                        <button
                            ...
                            className="flex h-14 w-full touch-manipulation items-center justify-center rounded-3xl bg-[#FFC900] text-xl font-black tracking-tight text-[#a60000] shadow-[0_8px_20px_rgba(0,0,0,0.15)] transition-all duration-75 select-none active:scale-[0.96] active:bg-[#e6b500]"
                        >
                            Sign In / Sign up
                        </button>
                        <button
                            ...
                            style={{ WebkitTapHighlightColor: 'transparent' }}
                            className="flex h-14 w-full touch-manipulation items-center justify-center text-xl font-black tracking-tight text-[#FFC900] transition-all duration-75 select-none active:scale-[0.96] active:opacity-60"
                        >
                            Skip to Menu
                        </button>
                    </div>
                ...
                >
                    <Drawer.Portal>
                        ...
                        <Drawer.Content className="fixed right-0 bottom-0 left-0 z-[9999] flex flex-col rounded-t-[32px] bg-white shadow-[0_-20px_40px_rgba(0,0,0,0.25)] outline-none">
                            <div className="w-full px-5 pt-5 pb-8 text-black">
                                <div className="mx-auto mb-6 h-1.5 w-12 flex-shrink-0 rounded-full bg-black/10 lg:hidden" />
                                <div className="mb-4 flex items-center">
                                    <button
                                        ...
                                        className="-ml-3 flex items-center gap-2 rounded-full px-3 py-1.5 text-sm font-bold text-black/65 transition hover:bg-black/5"
                                    >
                                        <ArrowLeft size={16} />
                                        Back
                                    </button>
