 ...
 */
export function generateConsistentRating(id: string | undefined | null, fallback: number = 4.5): string {
 ...
 */
export function formatRatingForDisplay(rating: string): { fullStars: number; hasHalfStar: boolean } {
