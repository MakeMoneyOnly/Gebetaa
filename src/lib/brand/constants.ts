...
// Brand Strategy
export const BRAND_PURPOSE = "To provide the invisible, bulletproof infrastructure that powers the heartbeat of hospitality. Gebeta exists to eliminate operational chaos, allowing restaurateurs to focus on the art of service rather than the friction of technology.";

export const MISSION_STATEMENT = "To empower hospitality businesses with a unified, resilient, and intelligent operating system that optimizes every touchpoint—from the kitchen line to the customer’s table.";

export const VISION_STATEMENT = "To be the global standard for hospitality infrastructure, starting in Africa, where every restaurant runs on a frictionless, data-driven ecosystem.";

export const CORE_VALUES = {
  OPERATIONAL_INTEGRITY: "Our systems are built for 100% uptime. Reliability is our primary product.",
  COGNITIVE_CLARITY: "We minimize noise. Our UI provides the exact information needed at the exact moment it is required.",
  HIGH_VELOCITY_EFFICIENCY: "Every tap is a cost. We optimize workflows to save seconds that turn into hours over a month.",
  EMPOWERMENT_THROUGH_DATA: "We don't just process orders; we provide the insights that help owners reclaim their margins."
};
...
export const BRAND_POSITIONING = {
  ...
  DIFFERENTIATION: "Gebeta is not a 'tool'; it is the nervous system. We win by offering deep vertical integration (Consumer > KDS > POS > Admin) on a single, resilient enterprise-grade light-themed architecture."
};
...
export const UI_PRINCIPLES = {
  SPEED_OVER_DECORATION: "Prioritize instant loading and fast tap-responses over transition animations",
...
export const BRAND_VOICE = {
  ...
  DESCRIPTION: "We speak with the brevity of a Head Chef and the clarity of a Software Engineer. No fluff. No puns.",
