...
describe('Password Policy', () => {
    describe('validatePassword', () => {
        ...
        it('should reject password with repeated characters', () => {
            ...
            expect(result.valid).toBe(false);
            expect(result.errors).toContain('Password must not contain repeated characters (e.g., aaa, 111)');
        });
        ...
        it('should reject password with sequential letters', () => {
            ...
            expect(result.valid).toBe(false);
            expect(result.errors).toContain('Password must not contain sequential characters (e.g., abc, 123)');
        });
