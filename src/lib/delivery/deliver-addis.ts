...
export async function createOrder(
    ...
    try {
        ...
        return {
            success: true,
            deliver_addis_order_id: data.gebeta_order_id || data.order_id,
            partner_order_id: order.partner_order_id,
            status: data.status,
...
/**
 * Map Deliver Addis order status to Gebeta status
 */
export function mapStatusToGebeta(status: string): DeliverAddisOrderStatus {
...
/**
 * Map Gebeta status to Deliver Addis status
 */
export function mapStatusToDeliverAddis(gebetaStatus: DeliverAddisOrderStatus): string {
