...
const envSchema = z.object({
    ...
    TELEBIRR_API_BASE_URL: z.union([z.string().url(), z.literal('')]).optional(),
    TELEBIRR_APP_ID: z.string().optional(),
    TELEBIRR_APP_KEY: z.string().optional(),
    PAYMENT_PROVIDER_FALLBACK_ENABLED: z.coerce.boolean().default(true),
    PAYMENT_PROVIDER_FALLBACK_ORDER: z.string().default('telebirr,chapa'),
    SENDGRID_API_KEY: z.string().optional(),
    SENDGRID_FROM_EMAIL: z.string().email().optional(),
    KDS_PRINTER_WEBHOOK_SECRET: z.string().min(16).optional(),
    INVOICE_OCR_PROVIDER_ORDER: z.string().default('oss,azure,google,aws'),
    INVOICE_OCR_OPEN_SOURCE_ENDPOINT: z.string().url().optional(),
    INVOICE_OCR_OPEN_SOURCE_API_KEY: z.string().optional(),
    AZURE_DOCUMENT_INTELLIGENCE_ENDPOINT: z.string().url().optional(),
    AZURE_DOCUMENT_INTELLIGENCE_API_KEY: z.string().optional(),
    AZURE_DOCUMENT_INTELLIGENCE_MODEL_ID: z.string().optional(),
    AZURE_DOCUMENT_INTELLIGENCE_API_VERSION: z.string().optional(),
    GOOGLE_DOCUMENT_AI_PROCESSOR_NAME: z.string().optional(),
    GOOGLE_DOCUMENT_AI_SERVICE_ACCOUNT_JSON: z.string().optional(),
...
const serverEnvSchema = z.object({
    ...
    CHAPA_SECRET_KEY: z.string().optional(),
    TELEBIRR_API_BASE_URL: z.string().optional(),
    TELEBIRR_APP_ID: z.string().optional(),
    TELEBIRR_APP_KEY: z.string().optional(),
    SENDGRID_API_KEY: z.string().optional(),
    KDS_PRINTER_WEBHOOK_SECRET: z.string().optional(),
    INVOICE_OCR_PROVIDER_ORDER: z.string().optional(),
    INVOICE_OCR_OPEN_SOURCE_ENDPOINT: z.string().optional(),
    INVOICE_OCR_OPEN_SOURCE_API_KEY: z.string().optional(),
