...
export const kds = {
  statusColors: {
    pending: { bg: colors.surface.elevated, text: colors.text.secondary, border: colors.surface.border },
    acknowledged: { bg: colors.brand.mint, text: colors.brand.crimson, border: colors.brand.mintDark },
    preparing: { bg: colors.brand.crimsonLight, text: colors.brand.crimson, border: colors.brand.crimson },
    ready: { bg: colors.semantic.successLight, text: colors.semantic.success, border: colors.semantic.success },
    served: { bg: colors.surface.elevated, text: colors.text.muted, border: colors.surface.border },
    cancelled: { bg: colors.semantic.errorLight, text: colors.semantic.error, border: colors.semantic.error },
  },
} as const;
