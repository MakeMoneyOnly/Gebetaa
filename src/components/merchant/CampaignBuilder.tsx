        ...
        <section className="rounded-[2rem] border border-gray-100 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Create guest campaigns and launch with one click.</p>
                </div>
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">
                                        {campaign.channel.toUpperCase()} | {campaign.tracking?.total ?? 0} deliveries | {campaign.tracking?.converted ?? 0} conversions
                                    </p>
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        disabled={launchingId === campaign.id || campaign.status === 'running'}
                                    ...
                                    >
                                        {launchingId === campaign.id ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : null}
                                        Launch
                                    </button>
                                </div>
                            </div>
