            ...
            <div className="animate-in fade-in slide-in-from-bottom-2 space-y-8 pb-12 duration-500">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Configure wages and permissions for a new job.</p>
                    </div>
                    <button 
                    ...
                    <div className="rounded-4xl border border-gray-100 bg-white p-8">
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-400">Job Name <span className="text-red-500">*</span></label>
                                <input type="text" className="w-full rounded-xl border border-gray-200 bg-gray-50/30 px-4 py-3 text-sm font-semibold text-gray-900 outline-none focus:border-[#DDF853] focus:ring-1 focus:ring-[#DDF853]" placeholder="e.g. Senior Server" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-400">Tipped Job</label>
                                <div className="flex h-[46px] items-center justify-between rounded-xl border border-gray-200 bg-gray-50/30 px-4">
                                    <span className="text-sm font-semibold text-gray-900">Participates in Tip Pool</span>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-400">Default Wage (ETB)</label>
                                <input type="number" className="w-full rounded-xl border border-gray-200 bg-gray-50/30 px-4 py-3 text-sm font-semibold text-gray-900 outline-none focus:border-[#DDF853] focus:ring-1 focus:ring-[#DDF853]" placeholder="0" />
                            </div>
                            <div className="space-y-2">
                    ...
                    <div className="rounded-4xl border border-gray-100 bg-white p-8">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2 md:w-1/2">
                                <label className="text-sm font-medium text-gray-400">POS Access Level</label>
                                <ModernSelect options={[{ value: 'none', label: 'No Access' }, { value: 'basic', label: 'Basic Ordering' }, { value: 'manager', label: 'Manager (Voids/Discounts)' }]} />
                            </div>

                            <div>
                                <label className="text-sm font-medium text-gray-400 block mb-3">Web Dashboard Modules</label>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    {[
                                        ...
                                        <div key={i} className="flex h-[46px] items-center justify-between rounded-xl border border-gray-100 bg-gray-50/10 px-4">
                ...
                <div className="overflow-x-auto rounded-2xl border border-gray-100">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-50 text-sm font-semibold text-gray-900">
                            {[
                                { name: 'Server', tipped: true, wage: '1,500 ETB / Month', pos: 'Basic', emps: 12 },
                                { name: 'Line Cook', tipped: true, wage: '5,000 ETB / Month', pos: 'No Access', emps: 8 },
                                { name: 'Cashier', tipped: false, wage: '3,500 ETB / Month', pos: 'Manager', emps: 4 },
                            ].map((job, i) => (
                                <tr key={i} className="hover:bg-gray-50/30">
                                    <td className="px-4 py-4">{job.name}</td>
                                    <td className="px-4 py-4">
                                        {job.tipped ? (
                                            <span className="rounded-lg bg-green-50 px-2 py-1 text-[10px] font-bold text-green-600 uppercase">Yes</span>
                                        ) : (
                                            <span className="rounded-lg bg-gray-100 px-2 py-1 text-[10px] font-bold text-gray-500 uppercase">No</span>
                                        )}
                                    </td>
