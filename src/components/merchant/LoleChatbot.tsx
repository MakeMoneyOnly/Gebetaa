            ...
            <div className="mt-3 rounded-2xl border border-gray-200 bg-[#F8F9FA] transition-all focus-within:border-black/30 focus-within:shadow-sm">
                ...
                <div className="flex items-center justify-between px-3 pt-1 pb-2.5">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.93 }}
                        className="flex h-7 w-7 items-center justify-center rounded-xl bg-[#DDF853] text-black shadow-sm transition-all hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-40"
                    >
                        {isTyping ? (
