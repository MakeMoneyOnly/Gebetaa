            ...
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Review expected vs actual stock, waste value, and variance exposure.
                    </p>
                </div>
                ...
                <>
                    <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-4">
                        ...
                        <div className="rounded-xl border border-amber-100 bg-amber-50/70 p-3">
                            <p className="text-xs tracking-wide text-amber-700 uppercase">
                                Low Stock
                            </p>
                            <p className="mt-1 text-xl font-bold text-amber-700">
                                {totals?.low_stock_items ?? 0}
                            </p>
                        </div>
                            ...
                            <tbody>
                                {rows.map(row => (
                                    <tr key={row.item_id} className="border-b border-gray-50">
                                        ...
                                        <td className="py-3 pr-3 text-gray-800">
                                            {row.theoretical_stock.toFixed(2)}
                                        </td>
